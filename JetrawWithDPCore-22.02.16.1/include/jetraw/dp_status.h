...
typedef enum dp_status {
    ...
    dp_not_initialized,  ///< Missing initialization.
    ...
    dp_parameter_error,     ///< Parameters cannot be used in given context
    dp_image_too_small,  ///< Image has too few pixels for reliable preparation
    dp_out_of_range,     ///< Parameter is out of range
    ...
    dp_tiff_wrong_file_mode,  ///< Only w and r modes are accepted to open tiff
                              ///< files
    dp_bad_image,  ///< The image data is invalid or not compatible with jetraw
                    ///< compression.
